...
import ImageJoumusame from '../../../resources/Joumusame.jpeg'

const Seed3 = ({seedCount, setSeedCount, learningRound, setLearningRound}) => {
  ...
  return (
    <div style={{ margin: "0 15vw" }}>
      ...
      <div style={{ marginBottom:'5%', textAlign:'center'}}>
        {!showGraph && <img src={ImageJoumusame} alt="Joumusame" />}
        <b style={{ fontSize: "40px", textDecoration:'underline' }}><br/>Irrigation: Joumusame<br/></b>
          ...
          <div>
            ...
            <p>
              You have completed <b>15</b> Learnings Rounds.
                  ...
                  understand your <b>Joumusame</b> seed crop, you can choose to continue
                  with another crop. Alternatively, you can learn about <b>Joumusame</b> seed for another <b>5 rounds</b>
            </p>
}
