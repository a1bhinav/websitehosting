    ...
    <div>
      <Layout className="layout">
        <h1 className="header-style-normal" style={{ fontSize: "25px" }}>
          Training Round {currentQuestion + 1}/20 - Irrigation: Joumusame
                ...
                >
                  ...
                  {currentQuestion === 14 && (
                    <p>
                      ...
                      <br />
                      If you feel like you understand your <b>Joumusame</b> seed
                      crop, you can choose to continue with another crop.
                      Alternatively, you can learn about <b>Joumusame</b> seed
