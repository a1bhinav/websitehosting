...
const Seed1 = ({
  ...
  const handleOk = () => {
    if (currentQuestion > 14 && currentQuestion < 19) {
      ...
      modelValues.push(
        Math.floor(0.3 * nums[currentQuestion].x + 0.3 * nums[currentQuestion].y + 0.3 * nums[currentQuestion].z)
      );
    ...
    <div>
      <Layout className="layout">
        <h1 className="header-style-normal" style={{ fontSize: "25px" }}>
          Training Round {currentQuestion + 1}/20 - Irrigation: Meemmaseed
          {!showGraph && <img src={ImageMeemmaseed} alt="Meemmaseed" />}
        </h1>
                ...
                >
                  ...
                  {currentQuestion === 14 && (
                    <p>
                      ...
                      <br />
                      If you feel like you understand your <b>Meemmaseed</b> seed
                      crop, you can choose to continue with another crop.
                      Alternatively, you can learn about <b>Meemmaseed</b> seed
